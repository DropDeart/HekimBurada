...
/// <summary>Türkiye'nin 81 ili ve bağlı ilçeleri — Province/District tablolarının seed verisi.
/// CodeGen tarafından üretilmez, elle eklendi (kaynak: açık veri, bkz. plan notu).</summary>
internal static class RegionSeedData
{
