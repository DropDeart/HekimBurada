...
/// <summary>
/// HekimBurada'nın kapalı-platform kuralı: yalnızca admin onaylı ("approved") doktorlar konu
/// başlığı açabilir. CodeGen dışı, elle eklendi — Identity'ye gRPC ile canlı sorgulanır (JWT'ye
