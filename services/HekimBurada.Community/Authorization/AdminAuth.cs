...
namespace Community.Authorization;

/// <summary>
/// Admin panelinin moderasyon uçları (kategori yönetimi, yorum kaldırma) için rol/sahiplik kontrolü —
/// CodeGen dışı, elle eklendi. Identity servisinin ihraç ettiği rol adlarıyla (SeedData.AdminRole/
/// SuperAdminRole) birebir eşleşmeli; ayrı deploy edilen serviste derleme zamanı paylaşım yok.
///
